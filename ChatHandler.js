...
const chat_names = ["Shreyansh Gupta", "Uday Tyagi", "Aman Singh", "Apurv Kumar", "Shruti Singhal", "Rohit Sharma", "Sachin"];
const chat_names_length = chat_names.length;
const chat_msg = ["Hello Shreyansh Kaisa hai...",
    "Kya kr rha!...",
    "I am Going for a trip to Banglore..",
